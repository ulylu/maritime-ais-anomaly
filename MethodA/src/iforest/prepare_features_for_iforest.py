...
def main() -> None:
    ...
    ap.add_argument(
        "--input",
        default="preprocessing/output/ais_features.csv",
        help="Input CSV path (default: preprocessing/output/ais_features.csv).",
    )
    ap.add_argument(
        "--output-dir",
        default="method_A/output",
        help="Output folder (default: method_A/output).",
    )
    ap.add_argument(
        "--no-log-dist",
        action="store_true",

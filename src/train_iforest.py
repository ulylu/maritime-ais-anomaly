...
DEFAULT_X = "output/ais_features_methodA_X.csv"
DEFAULT_META = "output/ais_features_methodA_meta.csv"
DEFAULT_MODEL = "output/models/iforest_methodA.joblib"
DEFAULT_SCORES = "output/ais_methodA_scores.csv"
DEFAULT_TOP = "output/ais_methodA_top1pct.csv"
DEFAULT_SUMMARY = "output/methodA_summary.txt"
